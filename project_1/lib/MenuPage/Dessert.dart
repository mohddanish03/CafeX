...
class DessertMenu extends StatefulWidget {
  DessertMenu({Key? key}) : super(key: key);

  @override
  _DessertStateMenu createState() => _DessertStateMenu();
}

class _DessertStateMenu extends State<DessertMenu> {
  AddToBookMark bookMark = AddToBookMark();

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('Dessert').snapshots(),
